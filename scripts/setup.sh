...
echo ""
echo "Add this to your config.toml under [web.admin]:"
...
echo ""
echo "Next steps:"
echo "  1. Edit config.toml with your domain settings"
echo "  2. Add the password hash to config.toml"
echo "  3. Configure DNS records (see docs/dns_records.md)"
echo "  4. Run: ./gomail -config config.toml"
echo ""
